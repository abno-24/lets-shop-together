                ...
                <input
                  ...
                  onChange={
                    (e) => e.target.value === '' || e.target.value === '0' ? null :
                      updateQuantity(product._id, product.size, Number(e.target.value))
                  }
                />
                <img onClick={() => updateQuantity(product._id, product.size, 0)} className='w-4 mr-4 sm:w-5 cursor-pointer' src={assets.bin_icon} alt="" />
              </div>
            )
          })
        }
